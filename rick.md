---
layout: page
discription: Examples for Rick Persona
---

<h2 id="rick">Rick</h2>

<p><img src="/images/Rick_portrait.jpg" alt="fig:RickPortrait" title="Rick" /></p>
...
<p>Rick is a clean-water plant operator, responsible for ensuring that
...
plant’s nearby reservoir.</p>

<p>During his working shifts (he works a 5 + 1 continental shift), Rick
...
<p>At the start of every shift, Rick checks AJS to see what work he is
...
<p>Rick isn’t particularly concerned about people trying to hack into the
...
<p>Rick is aware of Information Security communiques on InfoPortal, but
...
the telemetry system.</p>

<p>Although Rick can call an instrument tech for many problems, experience
...
<p>Rick has been a plant operator for over 10 years. Although the exact
...
<p>This experience does not stay in Rick’s head. When problems have
...
there will be productivity improvements without an adverse impact.</p>

<p>Rick uses the SCADA’s trend monitoring facilities as an indication of
...
using panel PCs at remote locations around the plant.</p>

<h4 id="motivations">Motivations</h4>

<p>Because the water quality can change over a matter of minutes, Rick’s
...
eventual piecing together of the elements of an event.</p>

<p>Although information security doesn’t phase Rick too much, personal
...
station, but what happens if we get problems on the way?”</p>

<h4 id="skills">Skills</h4>

<p>Rick has a basic operating knowledge of Windows; enough to carry out his
day-to-day routines, check his email, and navigate the main sections of
InfoPortal.</p>

<p>Rick isn’t a power-user; he acknowledges that younger “whizz kids” are
...
not authorised to use it.”</p>

<h2 id="argumentation-models">Argumentation Models</h2>

<h4 id="activities-1">Activities</h4>

<p><img src="/images/RickActivitiesModel.pdf" alt="fig:RickActivities" /></p>

<h4 id="attitudes-1">Attitudes</h4>

<p><img src="/images/RickAttitudesModel.pdf" alt="fig:RickAttitudes" /></p>

<h4 id="aptitudes">Aptitudes</h4>

<p><img src="/images/RickAptitudesModel.pdf" alt="fig:RickAptitudes" /></p>

<h4 id="motivations-1">Motivations</h4>

<p><img src="/images/RickMotivationsModel.pdf" alt="fig:RickMotivations" /></p>

<h4 id="skills-1">Skills</h4>

<p><img src="/images/RickSkillsModel.pdf" alt="fig:RickSkills" /></p>
...
<p><a href="https://github.com/failys/cairis/blob/master/examples/personas/Rick/Rick.xml">CAIRIS model</a></p>
